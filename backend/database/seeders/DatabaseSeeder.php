...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $projects[0]->users()->attach([$users[0]->id, $users[1]->id]);
        $projects[1]->users()->attach([$users[1]->id, $users[2]->id]);
        $projects[2]->users()->attach([$users[2]->id, $users[3]->id]);
        $projects[3]->users()->attach([$users[0]->id, $users[3]->id]);
        ...
        $this->command->info('Admin login: admin@hse-kpi.com / password123');
    }
}
