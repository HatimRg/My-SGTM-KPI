...
class EcartsSgtmSheet implements FromArray, WithTitle, WithStyles, WithDrawings, WithEvents
{
    ...
    public function array(): array
    {
        ...
        if ($this->deviations->isEmpty()) {
            $rows[] = ['Aucun écart SGTM cette semaine', '', '', '', '', '', '', '', '', '', '', '', ''];
        }
    ...
    public function drawings()
    {
        ...
        foreach ($this->deviations as $deviation) {
            ...
            // Corrective action photo (column K) - use correct field name
