...
class MachinesFailedRowsExport implements FromArray, WithColumnWidths, WithEvents, WithTitle
{
    private array $rows;
    private string $lang;
    ...
    {
        $out = [];
        $out[] = [$this->tr('SGTM - RAPPORT DES LIGNES EN ERREUR (ENGINS)', 'SGTM - FAILED ROWS REPORT (MACHINES)')];
        $out[] = [$this->tr(
