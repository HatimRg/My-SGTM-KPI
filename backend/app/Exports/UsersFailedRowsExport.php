...
class UsersFailedRowsExport implements FromArray, WithColumnWidths, WithEvents, WithTitle
{
    private array $rows;
    private string $lang;
    ...
    {
        $out = [];
        $out[] = [$this->tr('SGTM - RAPPORT DES LIGNES EN ERREUR (UTILISATEURS)', 'SGTM - FAILED ROWS REPORT (USERS)')];
        $out[] = [$this->tr(
