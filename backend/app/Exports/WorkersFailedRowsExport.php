...
class WorkersFailedRowsExport implements FromArray, WithColumnWidths, WithEvents, WithTitle
{
    private array $rows;
    private string $lang;
    ...
    {
        $out = [];
        $out[] = [$this->tr('SGTM - RAPPORT DES LIGNES EN ERREUR (TRAVAILLEURS)', 'SGTM - FAILED ROWS REPORT (WORKERS)')];
        $out[] = [$this->tr(
