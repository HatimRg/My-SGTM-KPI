...
import { Search, X, Image as ImageIcon, Filter, ChevronDown, ChevronUp, Plus, Check, Download, FileSpreadsheet } from 'lucide-react'
...
export default function Training() {
  ...
  const participantsNumber = Number(participants) || 0
