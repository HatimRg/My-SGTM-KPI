          ...
          <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200 dark:border-gray-700">
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">HSE KPI Tracker</p>
              </div>
            </div>
            <button
              onClick={() => setSidebarOpen(false)}
      ...
      <div className="lg:pl-72">
        ...
        <header className="sticky top-0 z-30 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between h-16 px-4 sm:px-6">
            ...
            {/* Search placeholder */}
            <div className="hidden sm:block flex-1 max-w-lg ml-4">
              <div className="relative">
                <input
                  type="text"
                  placeholder={`${t('common.search')}...`}
                  className="w-full pl-10 pr-4 py-2 text-sm bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-hse-primary focus:border-transparent dark:text-gray-100 dark:placeholder-gray-500"
                />
                <svg
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative">
                ...
                {notificationDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-96 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 animate-fade-in z-50">
