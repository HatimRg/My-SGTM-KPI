          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                <div className="text-3xl font-bold">{stats.hse_compliance > 0 ? `${stats.hse_compliance}%` : '-'}</div>
                <div className="text-sm text-white/70">{language === 'fr' ? 'Conformité HSE' : 'HSE Compliance'}</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                <div className="text-3xl font-bold">{stats.training_hours > 0 ? stats.training_hours.toLocaleString() : '-'}</div>
