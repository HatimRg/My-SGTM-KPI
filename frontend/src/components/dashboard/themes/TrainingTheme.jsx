  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card">
          <div className="card-header">
            <h3 className="font-semibold text-gray-900 dark:text-gray-100">{t('dashboard.training.trainingByDuration') || 'Training by Duration'}</h3>
          </div>
          <div className="card-body">
            <div className="h-64">
              {trainingByDuration.length > 0 ? (
                ...
                <div className="flex items-center justify-center h-full text-gray-400">
                  <p className="font-medium">No duration data</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="card-body">
            <div className="h-72">
              {awarenessByTheme.length > 0 ? (
                ...
                <div className="flex items-center justify-center h-full text-gray-400">
                  <p className="font-medium">No awareness session data</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="card-body">
            <div className="h-64">
              {trainingByType.length > 0 ? (
                ...
                <div className="flex items-center justify-center h-full text-gray-400">
                  <p className="font-medium">No type data</p>
                </div>
              )}
            </div>
          </div>
      ...
      {awarenessMetrics.totalSessions > 0 && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <MetricCard
            title={t('dashboard.training.totalAwareness') || 'TBT/TBM Sessions'}
          ...
          />
          <MetricCard
            title={t('dashboard.training.awarenessParticipants') || 'Awareness Participants'}
            value={awarenessMetrics.totalParticipants}
            icon={Users}
            color="purple"
          />
          <MetricCard
            title={t('dashboard.training.awarenessHours') || 'Awareness Hours'}
