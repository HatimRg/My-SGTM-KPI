...
export default function DailyKpiEntry({ projectId, weekNumber, year, onDataConfirmed }) {
  ...
  const handleApplyAutoFill = () => {
    ...
    const updatedData = dailyData.map(day => {
      ...
      return {
        ...day,
        releve_ecarts: autoValues.releve_ecarts || day.releve_ecarts || '',
        sensibilisation: autoValues.sensibilisation || day.sensibilisation || '',
        heures_formation: autoValues.heures_formation || day.heures_formation || '',
        permis_travail: autoValues.permis_travail || day.permis_travail || '',
        // Apply work hours formula: effectif × 10
        heures_travaillees: day.effectif ? day.effectif * 10 : day.heures_travaillees || '',
      }
    })
